 ...
 * Modified by illuminare
 */

class PeerConnectionPlay {
    constructor(props) {
        // munge plug-in
    ...
    gotDescription(description) {
        let _this = this;
        console.log('PeerConnectionPlay.gotDescription');
    ...
    wsConnect(url) {
        let _this = this;
        console.log('PeerConnectionPlaysConnect: ' + url);
        ...
        this.wsConnection.onopen = function () {
            console.log("PeerConnectionPlay.onopen");
    ...
    start() {
        ...
        if (this.peerConnection == null) {
            console.log("PeerConnectionPlay.start: sdpURL:" + this.sdpURL + " streamInfo:" + JSON.stringify(this.streamInfo));
            this.wsConnect(this.sdpURL);
        }
        else {
            console.log('PeerConnectionPlay.start: peerConnection already in use, not starting');
        }
    }
    ...
    getAvailableStreams() {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (_this.peerConnection == null) {
                ...
                reject({ message: "PeerConnectionPlay.getAvailableStreams: peerConnection already in use" })
            }
        });
    }
...
export default PeerConnectionPlay;